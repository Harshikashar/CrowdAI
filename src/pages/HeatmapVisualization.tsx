...
const HeatmapVisualization = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto px-4 pt-24 pb-10 flex-1">
        <h1 className="text-3xl font-bold mb-8">Crowd Heatmap Visualization</h1>
...
const HeatmapVisualization = () => {
  ...
  useEffect(() => {
    if (location.state?.detectionData) {
      setHeatmapData(location.state.detectionData);
      toast({
        title: "Heatmap Generated",
        description: `Analysis from detection at ${new Date(location.state.timestamp).toLocaleTimeString()}`,
      });
    }
